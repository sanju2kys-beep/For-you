...
{\*\expandedcolortbl;;}
\paperw11900\paperh16840\margl1440\margr1440\vieww29200\viewh15940\viewkind0
\pard\tx720\tx1440\tx2160\tx2880\tx3600\tx4320\tx5040\tx5760\tx6480\tx7200\tx7920\tx8640\pardirnatural\partightenfactor0

\f0\fs24 \cf0 /* =========================================================\
   FULL WORKING JS (Opening \uc0\u8594  Letter \u8594  Menu \u8594  Memory Lane \u8594  Quiz \u8594  Photo Booth \u8594  Ending)\
...
const QUIZ = [\
  \{\
    ...
    correct: 2,\
    correctMsg: "Correct \uc0\u55357 \u56844  but i know you wont agree with me \u55357 \u56471 ",\
    wrongMsg: "Hmm nope \uc0\u55358 \u56690  but nice try\'85"\
  \},\
  \{\
    question: "What is that one thing i like the most about you?",\
    options: ["How you respect others", "Way of expressing", "Every thing that defines you", "None fo the above \uc0\u55357 \u56847 "],\
    correct: 2,\
    correctMsg: "Correct \uc0\u55357 \u56847  you know the truth \u55357 \u56469 ",\
    wrongMsg: "Wrong answer \uc0\u55357 \u56844  you know it\'85"\
  \},\
  \{\
    ...
    correct: 1,\
    correctMsg: "Correct, that deep talk helped\uc0\u55357 \u56471 ",\
    wrongMsg: "Hmm nope \uc0\u55358 \u56690  think again\'85"\
  \},\
  \{\
    question: "What would be the sukoon moment for me ?",\
    options: ["When we go for a long drive", "Kiss", "Longggg hug", "Dancing together"],\
    correct: 2,\
    correctMsg: "Yes your hug feels like home\uc0\u55357 \u56471 ",\
    wrongMsg: "Hmm nope \uc0\u55358 \u56690  but nice try\'85"\
  \},\
  \{\
  ...
  \{\
    ...
    correct: 3,\
    correctMsg: "Nothing else will be there in my mind while listerning to this one\uc0\u55357 \u56471 ",\
    wrongMsg: "Try harder next time\'85"\
  \},\
  \{\
    ...
    correct: 3,\
    correctMsg: "Its still a dream \uc0\u55357 \u56471 ",\
    wrongMsg: "srsly???"\
  \}\
];\
\
...
function renderOpening() \{\
  app.innerHTML = `\
    <div class="card center">\
      <div class="heartBig">\uc0\u55357 \u56471 </div>\
      <h1>Hey love \uc0\u10084 \u65039 </h1>\
      <p>I made something for you. Take a breath\'85 and tap to start \uc0\u10024 </p>\
\
...
\
      <p class="small">Made with love \'95 just for you</p>\
    </div>\
  `;\
\}\
\
/* =======================\
   LETTER\
   ======================= */\
const LETTER = `Hey love \uc0\u10084 \u65039 \
\
I don\'92t know if I say this enough,\
...
\
  app.innerHTML = `\
    <div class="card">\
      <h2>For you, $\{escapeHtml(name)\} \uc0\u55357 \u56471 </h2>\
\
      <!-- \uc0\u9989  FIX: preserve new lines + nicer spacing -->\
      <div class="letterBox" style="white-space:pre-wrap; line-height:1.7;">$\{escapeHtml(LETTER)\}</div>\
\
      <div class="center">\
        <button class="heartBtn" onclick="renderMenu()">\uc0\u55357 \u56471 </button>\
        <div class="small">Tap the heart to continue</div>\
      </div>\
\
      <div class="btns">\
        <button class="secondary" onclick="renderOpening()">\uc0\u11013  Back</button>\
      </div>\
    </div>\
  `;\
\}\
...
\
  app.innerHTML = `\
    <div class="card">\
      <h2>Choose a box, $\{escapeHtml(her)\} \uc0\u55357 \u56471 </h2>\
      <p class="small">Start with Memory Lane, then try the quiz, then the photo booth.</p>\
\
      <div class="grid3">\
        <div class="box" onclick="renderMemoryLane()">\
          <div class="boxTitle">\uc0\u55357 \u57060 \u65039  Memory Lane</div>\
          <div class="boxSub">One photo at a time, write what comes to mind</div>\
        </div>\
\
        <div class="box" onclick="renderQuiz()">\
          <div class="boxTitle">\uc0\u55358 \u56800  Quiz</div>\
          <div class="boxSub">Pick an option \'97 get instant feedback</div>\
        </div>\
\
        <div class="box" onclick="renderPhotoBooth()">\
          <div class="boxTitle">\uc0\u55357 \u56568  Photo Booth</div>\
          <div class="boxSub">Pick 4 photos \uc0\u8594  get a photo strip</div>\
        </div>\
      </div>\
\
      <div class="btns" style="justify-content:center;">\
        <button onclick="renderEnding()">\uc0\u55357 \u56471  Finish</button>\
      </div>\
\
      <div class="btns">\
        <button class="secondary" onclick="goToLetter()">\uc0\u11013  Back to letter</button>\
        <button class="secondary" onclick="renderOpening()">\uc0\u55356 \u57312  Home</button>\
      </div>\
    </div>\
  `;\
\}\
  ...
  app.innerHTML = `\
    <div class="card">\
      <div class="row" style="justify-content:space-between;align-items:center;">\
        <h2 style="margin:0;">\uc0\u55357 \u57060 \u65039  Memory Lane</h2>\
        <button class="secondary" onclick="renderMenu()">\uc0\u11013  Menu</button>\
      </div>\
\
      <p class="small">One photo at a time. Write something to unlock Next \uc0\u55357 \u56471 </p>\
\
      <div id="memStage"></div>\
\
      <div class="btns">\
        <button class="secondary" onclick="renderEnding()">\uc0\u55357 \u56471  Finish</button>\
        <button class="secondary" onclick="renderOpening()">\uc0\u55356 \u57312  Home</button>\
      </div>\
    </div>\
  `;\
...
\
  if (memIndex >= MEMORY_PHOTO_IDS.length) \{\
    stage.innerHTML = `\
      <div class="center">\
        <h2 style="margin-top:6px;">You\'92re done \uc0\u55357 \u56471 </h2>\
        <p class="small">Now generate the memory letter.</p>\
\
        <div class="btns" style="justify-content:center;">\
          <button onclick="generateMemLetter()">Generate Memory Letter \uc0\u55357 \u56460 </button>\
...
\
    <p class="small" id="imgWarn" style="display:none;">\
      \uc0\u9888 \u65039  Image not loading. Make sure the Drive file is \'93Anyone with the link \u8594  Viewer\'94.\
    </p>\
\
    <textarea id="memInput" placeholder="Write what comes to your mind\'85" oninput="memTyping()">$\{escapeHtml(memNotes[memIndex])\}</textarea>\
\
    <div class="row" style="justify-content:space-between;">\
      <button class="secondary" onclick="memBack()" $\{memIndex === 0 ? "disabled" : ""\}>\uc0\u11013  Back</button>\
      <button id="memNextBtn" onclick="memNext()" disabled>\
        $\{memIndex === MEMORY_PHOTO_IDS.length - 1 ? "Finish \uc0\u9989 " : "Next \u10140 "\}\
      </button>\
    </div>\
  `;\
\
...
\
  const her = state.herName || "love";\
  const text =\
`\uc0\u55357 \u56471  Memory Letter for $\{her\} \u55357 \u56471 \
\
$\{memNotes.map((n, i) => `Memory $\{i + 1\}:\\n$\{n.trim() ? n.trim() : "\uc0\u55357 \u56471 "\}`).join("\\n\\n")\}\
\
(keep this with you \uc0\u55357 \u56844 )`;\
\
...
\
  app.innerHTML = `\
    <div class="card">\
      <div class="row" style="justify-content:space-between;align-items:center;">\
        <h2 style="margin:0;">\uc0\u55358 \u56800  Quiz</h2>\
        <button class="secondary" onclick="renderMenu()">\uc0\u11013  Menu</button>\
      </div>\
\
      <p class="small">Pick an option \uc0\u55357 \u56844 </p>\
...
\
  if (quizIndex >= QUIZ.length) \{\
    stage.innerHTML = `\
      <div class="center">\
        <h2>Done \uc0\u55357 \u56471 </h2>\
        <p class="small">That was cute \uc0\u55357 \u56844 </p>\
\
        <div class="btns" style="justify-content:center;">\
          <button onclick="renderQuiz()">Restart Quiz</button>\
          <button class="secondary" onclick="renderMenu()">\uc0\u11013  Back to menu</button>\
          <button onclick="renderEnding()">\uc0\u55357 \u56471  Finish</button>\
        </div>\
      </div>\
    `;\
...
\
    <div class="row" style="justify-content:flex-end;">\
      <button id="quizNext" onclick="nextQuiz()" style="display:none;">\
        $\{quizIndex === QUIZ.length - 1 ? "Finish \uc0\u9989 " : "Next \u10140 "\}\
      </button>\
    </div>\
  `;\
\}\
...
\
  if (i === q.correct) \{\
    feedback.textContent = q.correctMsg || "Correct \uc0\u55357 \u56471 ";\
  \} else \{\
    feedback.innerHTML = `\
      $\{escapeHtml(q.wrongMsg || "Nope \uc0\u55358 \u56690 ")\}\
      <br><br>\
...
\
/* =======================\
   PHOTO BOOTH (4 photos \uc0\u8594  strip \u8594  download)\
   ======================= */\
let boothImages = [];\
let boothTopText = "PHOTO BOOTH";\
let boothBottomText = "with love \uc0\u55357 \u56471 ";\
\
function renderPhotoBooth()\{\
  app.innerHTML = `\
    <div class="card">\
      <div class="row" style="justify-content:space-between;align-items:center;">\
        <h2 style="margin:0;">\uc0\u55357 \u56568  Photo Booth</h2>\
        <button class="secondary" onclick="renderMenu()">\uc0\u11013  Menu</button>\
      </div>\
\
      <p class="small">Upload 4 photos. We\'92ll make a cute photo strip and you can download it \uc0\u55357 \u56471 </p>\
\
      <div class="row">\
...
\
  ...
  ctx.fillText(boothBottomText || "with love \uc0\u55357 \u56471 ", W/2, H-40);\
\
  const pad = 80;\
  const gap = 28;\
...
I still choose you.  \
Every day.  \
In every version of my life. \uc0\u55357 \u56471 \
      </div>\
\
      <p class="small" style="margin-top:16px;">Thank you for being you.</p>\
\
      <div class="btns" style="justify-content:center;">\
        <button onclick="renderMenu()">\uc0\u11013  Go back</button>\
        <button class="secondary" onclick="renderOpening()">\uc0\u55356 \u57312  Start again</button>\
      </div>\
    </div>\
  `;\
\}\
